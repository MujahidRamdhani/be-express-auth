...
exports.buildFilterQueryLimitOffsetV2 = buildFilterQueryLimitOffsetV2;
function buildSearchQuery(searchFilters) {
  let whereClauseAndResult = [];
  let orQuerySearchArray = [];
...
function parseAndCheckRangeFilter(range) {
...
function buildRangedFilter(rangedFilters) {
  const whereClauseAndResult = [];
...
function buildFilterQueryLimitOffsetV2(filter) {
  let usedFilter = {
    where: {
      AND: [],
    },
