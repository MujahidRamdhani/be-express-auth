...
async function create(req, res) {
  ...
  return (0, response_utils_1.response_success)(res, serviceResponse.data, 'File uploaded successfully!');
}
async function getByUser(req, res) {
  ...
  if (!serviceResponse.status) return (0, response_utils_1.handleServiceErrorWithResponse)(res, serviceResponse);
  return (0, response_utils_1.response_success)(res, serviceResponse.data, 'Files retrieved successfully!');
}
