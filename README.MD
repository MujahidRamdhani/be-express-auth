...
![response](documentation/image-documentation/login.png)
...
![response](documentation/image-documentation/register.png)

## Get User Info Endpoint

### URL:

**GET** `http://localhost:9999/auth/me`
...
![response](documentation/image-documentation/me.png)
...
**POST** `http://localhost:9999/products/create`
...
![response](documentation/image-documentation/product-create.png)
...
**GET** `http://localhost:9999/products/?page=1&rows=1`
...
![response](documentation/image-documentation/product-paganation.png)
...
**GET** `http://localhost:9999/products/?userId=1&page=1&rows=1`
...
![response](documentation/image-documentation/product-filter.png)
...
**POST** `http://localhost:9999/sales/create`
...
![response](documentation/image-documentation/sales-create.png)
...
**GET** `http://localhost:9999/sales?page=1&rows=1`
...
![response](documentation/image-documentation/sales-get.png)

---

## Get Sales by User ID and Product ID Endpoint

### URL:

**GET** `http://localhost:9999/sales?userId=3&productId=1&page=1&rows=1`
...
![response](documentation/image-documentation/sales-filter.png)
...
**POST** `http://localhost:9999/file/create`
...
![response](documentation/image-documentation/file-create.png)
