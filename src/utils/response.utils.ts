 ...
 * @returns response
 */
export const response_handler = (res: Response, status: number, content: unknown = null, message = '', errors: Array<string> = []): Response => {
 ...
 */
export const response_bad_request = (res: Response, message = 'Bad Request', errors: Array<any> = []): Response => {
 ...
 * @param errors list of errors
 */
export const response_unauthorized = (res: Response, message = 'Unauthorized', errors: Array<string> = []): Response => {
 ...
 * @param errors list of errors
 */
export const response_forbidden = (res: Response, message = 'Forbidden', errors: Array<string> = []): Response => {
 ...
 * @param errors list of errors
 */
export const response_not_found = (res: Response, message = 'Not Found', errors: Array<string> = []): Response => {
 ...
 * @param errors list of errors
 */
export const response_conflict = (res: Response, message = 'Conflict', errors: Array<string> = []): Response => {
 ...
 * @param errors list of errors
 */
export const response_unprocessable_entity = (res: Response, message = 'Unprocessable Entity', errors: Array<string> = []): Response => {
 ...
 * @param errors list of errors
 */
export const response_internal_server_error = (res: Response, message = 'Internal Server Error', errors: Array<string> = []): Response => {
 ...
 * @param message description
 */
export const response_success = (res: Response, content: unknown = null, message = 'Success'): Response => {
 ...
 * @param message description
 */
export const response_created = (res: Response, content: unknown = null, message = 'Created'): Response => {
  return response_handler(res, 201, content, message, undefined);
};

export const handleServiceErrorWithResponse = (res: Response, serviceResponse: ServiceResponse<any>): Response => {
